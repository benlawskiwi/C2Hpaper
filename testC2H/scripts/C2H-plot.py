...
for i in range(0,np.size(a)):
    ...
    if aa == 1825.5990272609:
        plt.plot((aa,aa),(0,-b[i]),'C0')
    if aa == 3630.02149701572-ofs:
        plt.plot((aa,aa),(0,-b[i]),'C0')
    if aa == 2081.86799942435:
        plt.plot((aa,aa),(0,-b[i]),'C0')
    if aa == 4821.77350602297-ofs:
        plt.plot((aa,aa),(0,-b[i]),'w',lw='2.5')
        plt.plot((aa,aa),(0,-b[i]*0.6),'C1')
    if aa == 5117.34572422576-ofs:
        plt.plot((aa,aa),(0,-b[i]),'w',lw='2.5')
        plt.plot((aa,aa),(0,-b[i]*0.8),'C1')
    if aa == 5136.79551715929-ofs:
        plt.plot((aa,aa),(0,-b[i]*3),'C1')
    if aa == 4909.67040664068-ofs:
        plt.plot((aa,aa),(0,-b[i]*1.5),'C1')
    #plt.plot((aa,aa),(0,-b[i]),'C1')
