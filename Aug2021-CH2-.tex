...
\begin{figure}
	...
	\caption{(a) Velocity map image of C$_2$H$^-$ photodetachment at 355~nm. (b) Velocity map image of C$_2$D$^-$ at 355~nm. (c) Comparison of 355~nm photoelectron spectra from C$_2$H$^-$ and C$_2$D$^-$. Structure below $\sim 27,000~$cm$^{-1}$ is assigned to the ground state $\tilde{X} ^2\Sigma^+$, and structure above  $\sim 27,000~$cm$^{-1}$ is assigned to the excited $\tilde{A} ^2\Pi$ state.}
	\label{fig:1}
\end{figure}
