...
expt = np.loadtxt(f'../../C2H_ANU_PES/C2H-355nm.dat', unpack=True)

im = np.loadtxt(f'../../C2H_ANU_PES/C2H-355nm.txt')
...
plt.savefig('C2H-pyabel.png', dpi=75, bb_inches='tight')
plt.show()
...
plt.savefig('C2H-pyabel.pdf', dpi=300, bb_inches='tight')
plt.show()

np.savetxt('C2H-radial.dat',I*2/I.max())
