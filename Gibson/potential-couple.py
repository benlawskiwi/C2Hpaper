...
ax.view_init(elev=6, azim=13)
#ax.view_init(elev=30, azim=25)
ax.plot_surface(CC*0.529177, BAR, VV/1000, linewidth=0, color='C3')
#ax.plot_surface(CC*0.529177, BAR, Vpp/1000, linewidth=0, color='C2')
#ax.plot_surface(CC*0.529177, BAR, Vpm/1000, linewidth=0, color='C1')

ax.set_xlabel(r'$\nu_3$ CC stretch ($\AA$)')
ax.set_ylabel(r'$\nu_2$ CH bend')
ax.set_zlabel(r'coupling energy (1000 cm$^{-1}$)')
ax.set_xticks([-0.1, 0, 0.1])
ax.set_yticks([-1, 0, 1])

#coup = mpl.lines.Line2D([0],[0], linestyle="none", c='C0', marker = 'o')
...
#ax.legend([coup], [r'$V_{12}$'], numpoints = 1)
ax.text(0.2, 0.1, 3, r'$V_{12}$', color='C3', fontsize=16)

plt.savefig('potential-couple.png', dpi=100)
plt.show()
