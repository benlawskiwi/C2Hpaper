...
ax.plot_surface(CC*0.529177, BAR, Vpp/1000+24, linewidth=0, color='C1')
ax.plot_surface(CC*0.529177, BAR, Vsp/1000+24, linewidth=0, color='C0')
#ax.plot_surface(CC*0.529177, BAR, Vpm/1000, linewidth=0, color='C1')

ax.set_xlabel(r'CC stretch ($\AA$)')
ax.set_ylabel(r'$\angle$ CH bend (rad.)')
...
plt.savefig('potentialsurfx.png', dpi=100)
plt.show()
